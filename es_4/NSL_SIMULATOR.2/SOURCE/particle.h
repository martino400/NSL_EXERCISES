...
public: // Function declarations
  ...
  double getposition(int dim, bool xnew);// Get the position of the particle along a specific dimension, if true returns the current position, if false returns the previous position
