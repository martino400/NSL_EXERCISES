...
private:
  ...
  double _gofr_norm;    // Value for GOFR normalization
  double _gofr_volume;  // Value of volume for GOFR
...
public: // Function declarations
  ...
  void set_temp_and_restart(double t); // Method to restart the simulation with a new temperature 
