...
public:
    ...
    void create_citiesCIRC(string &info, Random &_rnd);   // Function to create cities on the circumfrence
    void create_citiesSQUARE(string &info, Random &_rnd); // Function to create cities in a square (x is [0;1) and y is [0;1))
    pair<double, double> point_in_square(Random &_rnd);   // Retruns x and y of points in a square
    pair<double, double> point_on_circle(Random &_rnd);   // Returns x and y of the city
