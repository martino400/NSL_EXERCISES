...
int main(int argc, char *argv[])
{
    ...
    string info_base = "../OUTPUT/GENERATIONS" + to_string(0) + "/PopulationGeneration";
    string info = info_base + to_string(generation_count) + ".dat";

    // Setup initial generation: initial population, sort by fitness, and write generation 0 on file
