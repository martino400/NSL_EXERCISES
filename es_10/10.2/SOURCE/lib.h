...
// Function that saves in population of rank == 0 the best trajectories and pastes the best trajectories for the different processes and the other trajectories 
// of the rank == 0 for indexes > size
void save_best_trajectories(TSP &GA, int rank, int size, trajectory &path_to_send, trajectory &path_to_recv, int worst_index, int n_cities){
